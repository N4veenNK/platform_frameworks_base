...
public class BatteryMeterView extends LinearLayout implements DarkReceiver {
    ...
    private static final int BATTERY_STYLE_RLANDSCAPE_STYLE_A = 7;
    private static final int BATTERY_STYLE_LANDSCAPE_STYLE_A = 8;
    private static final int BATTERY_STYLE_RLANDSCAPE_STYLE_B = 9;
    private static final int BATTERY_STYLE_LANDSCAPE_STYLE_B = 10;
    ...
    void scaleBatteryMeterViews() {
        ...
        batteryHeight = mBatteryStyle == BATTERY_STYLE_LANDSCAPE || mBatteryStyle == BATTERY_STYLE_RLANDSCAPE ?
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_height_landscape_default) : batteryHeight;
        batteryHeight = mBatteryStyle == BATTERY_STYLE_LANDSCAPE_STYLE_A || mBatteryStyle == BATTERY_STYLE_RLANDSCAPE_STYLE_A ?
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_height_landscape_style_a_b) : batteryHeight;
        batteryHeight = mBatteryStyle == BATTERY_STYLE_LANDSCAPE_STYLE_B || mBatteryStyle == BATTERY_STYLE_RLANDSCAPE_STYLE_B ?                                
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_height_landscape_style_a_b) : batteryHeight;
        ...
        batteryWidth = mBatteryStyle == BATTERY_STYLE_LANDSCAPE || mBatteryStyle == BATTERY_STYLE_RLANDSCAPE ?
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_width_landscape_default) : batteryWidth;
        batteryWidth = mBatteryStyle == BATTERY_STYLE_LANDSCAPE_STYLE_A || mBatteryStyle == BATTERY_STYLE_RLANDSCAPE_STYLE_A ?
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_width_landscape_style_a_b) : batteryWidth;
        batteryWidth = mBatteryStyle == BATTERY_STYLE_LANDSCAPE_STYLE_B || mBatteryStyle == BATTERY_STYLE_RLANDSCAPE_STYLE_B ?
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_width_landscape_style_a_b) : batteryWidth;
